"""Model matrix for the RIVA benchmark framework.

16 Ollama models spanning four capability tiers.
Identical to Cairn/ReOS model matrix for cross-project comparison.
"""
...
MODEL_MATRIX = [
    ...
    {"name": "phi3:mini-128k", "family": "phi3", "params": "3.8b",
    ...
    {"name": "llama3.1:8b-instruct-q5_K_M", "family": "llama3.1", "params": "8b",
     "rationale": "Meta's 8B instruct q5_K_M; popular production choice"},
    {"name": "mistral:latest", "family": "mistral", "params": "7b",
     "rationale": "Mistral 7B v0.3; strong on short structured outputs"},
    {"name": "codellama:7b", "family": "codellama", "params": "7b",
     "rationale": "Code-specialized; hypothesis: may excel at plan decomposition"},
    ...
    {"name": "codellama:13b", "family": "codellama", "params": "13b",
     "rationale": "Code-specialized 13B; tests if specialization helps at scale"},
    {"name": "qwen2.5:14b", "family": "qwen2.5", "params": "14b",
     "rationale": "Qwen family ceiling in practical GPU memory range"},
    {"name": "phi3:medium-128k", "family": "phi3", "params": "14b",
    ...
    {"name": "claude-sonnet-4-20250514", "family": "claude", "params": "api",
     "rationale": "Anthropic Sonnet 4; API baseline for comparison with local models"},
]

OLLAMA_MODELS = [m["name"] for m in MODEL_MATRIX if m["params"] != "api"]
